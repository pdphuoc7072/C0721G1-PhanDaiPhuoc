    ...
    public static void deleteStudent () {
        ...
        for (int i = 0; i < 100; i++) {
            if (studentList[i] != null) {
                ...
                System.out.print("Không có tên cần xóa: " + nameStudentToDelete + " trong danh sách này \n");
                break;
            }
        }
    }
    public static void editListStudent () {
        ...
        for (int i = 0; i < 100; i++) {
            if (studentList[i] != null) {
                ...
                System.out.print("Không có tên cần sửa: " + nameStudentToEdit + " trong danh sách này \n");
                break;
            }
        }
    }
    public static void searchListStudent () {
        ...
        for (int i = 0; i < studentList.length; i++) {
            if (studentList[i] != null) {
                ...
                System.out.print("Không có tên cần tìm: " + searchNameStudent + " trong danh sách này \n");
                break;
            }
        }
    }
